            ...
            <View style={backButtonVisible?styles.container8: styles.container10}>
                {
                    backButtonVisible?(
                        <Button
                            ...
                            buttonActiveStyle={{width: normDimens.DIMEN_100, height: normDimens.DIMEN_48, borderRadius: normDimens.DIMEN_60}}
                        />
                    ):null
                }
                <Button
