...
const Popular = (props: Props) => {
    ...
    const getListOfMoviesData = async (request: MoviePopularRC) => {
        movieUseCase
            .getMoviePopular({requestContent: request})
            .then((response) => {
                const newData = response?.results.map((item: MoviePopularItemContent)=>{
